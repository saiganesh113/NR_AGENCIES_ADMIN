        ...
        <Row>
          ...
          <Col md={10} className="main-content">
            ...
            <Row>
              <Col md={13}>
                <Card className="mb-3 shadow-sm">
                  <Card.Header>Slot Booking</Card.Header>
                  <Card.Body>
                    <Form>
                      <Row>
                        <Col>
                      ...
                      <Row>
                        <Col>
                          ...
                          <div className="d-flex justify-content-between">
                            <Button variant="outline-primary">14 Sun</Button>
                            <Button variant="outline-primary">15 Mon</Button>
                            <Button variant="outline-primary">16 Tue</Button>
                            <Button variant="primary">17 Wed</Button>
                            <Button variant="outline-primary">18 Thu</Button>
                            <Button variant="outline-primary">19 Fri</Button>
                            <Button variant="outline-primary">20 Sat</Button>
                          </div>
                        </Col>
                      </Row>
                      <Row className="mt-3">
                        <Col>
                          ...
                          <div className="d-flex justify-content-between">
                            <Button variant="outline-primary">10:00 AM</Button>
                            <Button variant="outline-primary">11:00 AM</Button>
                            <Button variant="primary">12:00 PM</Button>
                            <Button variant="outline-primary">01:00 PM</Button>
                            <Button variant="outline-primary">02:00 PM</Button>
                          </div>
                        </Col>
                      </Row>
                    </Form>
